...
from src.infra.repository.customer import insert_customer_repo, delete_customer_repo, get_customer_repo, update_customer_repo
...
async def get_customer(id_: int) -> JSONResponse:
    customer = await get_customer_repo(id_)
